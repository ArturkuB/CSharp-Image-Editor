...
namespace Image_Editor
{
    public partial class Form1 : Form
    {
        ...
        //kontrast, jasnosc
        private void ContrastBrightness()
        {
        ...
        //Mnożenie odwrotności Screen Mode
        ...
        //Lagodne Swiatlo Soft Light Mode
        ...
        //Rozcienczenie Color Dodge Mode
        ...
        //Przezroczystosc Transparency 1
            ...
            try
            {
                ...
                for (int y = 0; y < h; y++)
                {
                    for (int x = 0; x < w; x++)
                    {
                        ...
                        double r3 = 0.0;
                        r3 = ((1 - (double)(trackBar3.Value) / 10) * r2) + (((double)(trackBar3.Value) / 10) * r1);
                        r3 = r3 * 255;
                        if (r3 > 255)
                        {
                            r3 = 255;
                        ...
                        double g3 = 0.0;
                        g3 = ((1 - (double)(trackBar3.Value) / 10) * g2) + (((double)(trackBar3.Value) / 10) * g1);
                        g3 = g3 * 255;
                        if (g3 > 255)
                        {
                            g3 = 255;
                        ...
                        double b3 = 0.0;
                        b3 = ((1 - (double)(trackBar3.Value) / 10) * b2) + (((double)(trackBar3.Value) / 10) * b1);
                        b3 = b3 * 255;
                        if (b3 > 255)
                        {
                            b3 = 255;
            ...
            try
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    for (int x = 0; x < width; x++)
                    {
                        ...
                        r = ((double)(trackBar4.Value) / 10) * (Math.Pow(r, ((double)(trackBar5.Value) / 10)));
                        g = ((double)(trackBar4.Value) / 10) * (Math.Pow(g, ((double)(trackBar5.Value) / 10)));
                        b = ((double)(trackBar4.Value) / 10) * (Math.Pow(b, ((double)(trackBar5.Value) / 10)));
